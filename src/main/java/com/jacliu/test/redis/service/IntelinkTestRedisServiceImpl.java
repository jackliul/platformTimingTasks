...
@Component("intelinkTestRedisService")
public class IntelinkTestRedisServiceImpl implements RedisService {

	@Autowired
	@Qualifier("intlink_test_redisTemplate")
	private StringRedisTemplate intelinkTestRedisTemplate;

	// @Autowired
	// public void setRedisTemplate(StringRedisTemplate intlink_test_redisTemplate)
	// {
	// this.intelinkTestRedisTemplate = intlink_test_redisTemplate;
	// }
