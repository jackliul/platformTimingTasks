package com.jacliu.test.redis.util;
...
public final class JsonUtils {
	...
	public static <T> String toJson(T obj) {
		try {
			...
			e.printStackTrace();
			// LOGGER.error("class: {} serialize to JSON error: {}",
	...
	public static <T> T fromJson(String json, Class<T> cls) {
		try {
			...
			e.printStackTrace();
			// LOGGER.error("deserialize failed! JSON string: {}, class: {}, reason: {}",
			// json, cls, e);
		}
		return null;
	}
	...
	public static <E, T extends Collection<E>> T fromJson(String json, Class<E> cls, Class<T> collectionCls) {
		...
		try {
			...
			/*
			 * LOGGER.
			 * error("deserialize failed! JSON string: {}, Object class:{}, Collection class: {}, reason: {}"
