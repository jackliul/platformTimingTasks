...
import com.jacliu.test.exceptions.ScheduleException;
import com.jacliu.test.model.ScheduleJob;
import com.jacliu.test.quartz.AsyncJobFactory;
import com.jacliu.test.quartz.SyncJobFactory;
import com.jacliu.test.vo.ScheduleJobVo;

/**
 * author : fengjing createTime : 2016-08-04 description : 定时任务操作辅助类 version :
 * 1.0
 */
